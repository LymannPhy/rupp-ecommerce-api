            ...
            <div class="invoice-info">
                ...
                <div class="invoice-details">
                    ...
                    <div>
                        ...
                        <span
                            class="payment-status {{ strtolower($order['status']) === 'paid' ? 'status-paid' : (strtolower($order['status']) === 'cancelled' ? 'status-cancelled' : 'status-pending') }}">
                            {{ $order['status'] }}
                        </span>
                    </div>
                </div>
            ...
            <div class="customer-shipping">
                ...
                <div class="customer-details">
                    ...
                    @if (isset($order['orderDetail']) && isset($order['orderDetail']['province']))
                        <div><strong>Province:</strong> {{ $order['orderDetail']['province']['name'] ?? 'N/A' }}</div>
                    @else
                        <div><strong>Province:</strong> N/A</div>
                    @endif
                ...
                @if ($order['coupon'])
                    <tr>
                        ...
                        <td class="text-right discount">
                            -${{ number_format(($order['coupon']['discount_percentage'] / 100) * $order['sub_total_price'], 2) }}
                        </td>
                    </tr>
                @endif
                <tr>
